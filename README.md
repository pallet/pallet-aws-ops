...
[![Build Status](https://travis-ci.org/pallet/pallet-aws-ops.svg?branch=release/0.2.1)](https://travis-ci.org/pallet/pallet-aws-ops)
...
```clj
[com.palletops/pallet-aws-ops "0.2.1"]
```
